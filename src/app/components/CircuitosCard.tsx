...
export default function CircuitosCard({ circuito }: { circuito: Circuito }) {
  return (
    <Card>
      ...
      <Conteudo>
        ...
        <div>
          <Titulo>{circuito.nome}</Titulo>
          <Destino>{circuito.destinos}</Destino>
          ...
          <IconRow>
            <Icone>
              <Clock size={16} />
              <span>{circuito.duracao} dias</span>
            </Icone>
            <Icone>
              <BusFront size={16} />
        ...
        <BottomInfo>
          <Preco>R$ {circuito.preco}</Preco>
          <Link href={`/circuitos/${circuito.id}`} passHref>
